...
async function sendMessage() {
  ...
  if (lastAmbiguousQuery && yesWords.includes(msg.toLowerCase())) {
    await sendMessageWithQuery("Recommend " + lastAmbiguousQuery);
...
// Remove the start-button event listener since it doesn't exist in the HTML
// The showChat function is called directly from the button click
...
function renderFeaturedProducts() {
  ...
  container.innerHTML = featuredProducts
    ...
    <div class="product-card-featured">
      ...
      <img src="${product.image}" alt="${product.title}" class="product-img-featured" />
